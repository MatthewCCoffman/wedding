...
import { r as registryImage } from "../../../chunks/918428E3-CCCC-4905-95CB-A9FF8F044545.js";
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="registry-section svelte-jftpj1"><div class="photo-column svelte-jftpj1"><div class="photo-frame svelte-jftpj1"><img${attr("src", registryImage)}${attr("alt", copy.imageAlt)} loading="lazy" class="svelte-jftpj1"/> <span class="section-number svelte-jftpj1" aria-hidden="true">05</span></div></div> <div class="registry-content svelte-jftpj1"><p class="lead svelte-jftpj1">${escape_html(copy.message)}</p> <p class="details svelte-jftpj1">${escape_html(copy.details)}</p> <a class="registry-button svelte-jftpj1"${attr("href", registryUrl)} target="_blank" rel="noopener noreferrer">${escape_html(copy.button)} <span aria-hidden="true" class="svelte-jftpj1">↗</span></a></div></div>`;
